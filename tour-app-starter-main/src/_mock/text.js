...
export const title = [
  "Áp dụng 7 kỹ thuật bí mật này để cải thiện sự kiện",
  "Tin vào 7 huyền thoại về sự kiện khiến bạn không thể phát triển",
  "Đừng lãng phí thời gian! 7 sự thật cho đến khi bạn đạt được sự kiện của mình",
  "Cách 7 điều sẽ thay đổi cách bạn tiếp cận sự kiện",
  "Giải thưởng sự kiện: 7 lý do tại sao chúng không hoạt động và bạn có thể làm gì",
  "Sự kiện không cần phải khó khăn. Đọc 7 lời khuyên này",
  "Sự kiện là kẻ thù tồi tệ nhất của bạn. 7 cách để đánh bại nó",
  "Sự kiện với ngân sách hạn chế: 7 lời khuyên từ thời kỳ suy thoái",
  "Biết 7 bí mật này sẽ làm cho sự kiện của bạn trông tuyệt vời",
  "Làm chủ nghệ thuật sự kiện với 7 lời khuyên này",
  "Cuộc sống, công việc, sự nghiệp của tôi: Cách 7 sự kiện đơn giản giúp tôi thành công",
  "Tận dụng sự kiện - Đọc 7 lời khuyên này",
  "7 điều tiếp theo bạn nên làm để thành công trong sự kiện",
  "Thời gian đang cạn kiệt! Hãy nghĩ về 7 cách này để thay đổi sự kiện của bạn",
  "7 điều tốt nhất về sự kiện",
  "7 sai lầm lớn nhất về sự kiện bạn có thể dễ dàng tránh",
  "7 công ty sự kiện thành công nhất trong khu vực",
  "Nghĩ sự kiện của bạn an toàn? 7 cách bạn có thể mất nó ngay hôm nay",
  "Đang nghĩ về sự kiện? 7 lý do tại sao đã đến lúc dừng lại!",
  "7 nơi để có được ưu đãi về sự kiện",
  "Ứng dụng sự kiện Android tốt nhất",
  "Lời khuyên sự kiện tốt nhất bạn sẽ đọc trong năm nay",
  "30 lời khuyên tốt nhất cho sự kiện",
  "Việc sửa sự kiện có nên mất 30 bước không?",
  "A - Z về sự kiện",
  "30 điều tiếp theo cần làm ngay về sự kiện",
  "Hướng dẫn tối thượng về sự kiện",
  "30 câu nói hài hước hàng đầu về sự kiện",
  "30 câu nói hàng đầu về sự kiện",
  "7 bài học hàng đầu về sự kiện cần học trước khi bạn 30 tuổi",
  "7 cách hàng đầu để mua sự kiện đã qua sử dụng",
  "30 cách tốt nhất để bán sự kiện",
  "30 ý tưởng cho sự kiện",
  "30 bài học về sự kiện bạn cần học trước khi 40 tuổi",
  "30 phương pháp thống trị sự kiện",
  "30 điều cần làm ngay về sự kiện",
  "30 lời khuyên để phát triển sự kiện của bạn",
  "30 cách để tránh kiệt sức trong sự kiện",
  "30 cách để cải thiện sự kiện",
  "Cách tạo nhiều sự kiện hơn bằng cách làm ít hơn",
];
